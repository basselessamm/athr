...
/// The Quran class provides access to Quranic data (Arabic Uthmani text).
class Quran {
  ...
  static Map<int, Map<int, Verse>> getQuranVerses() {
    return _quranVerses;
  }
  ...
  static Verse getVerse({
    ...
    return getQuranVerses()[surahNumber]![verseNumber]!;
  }
